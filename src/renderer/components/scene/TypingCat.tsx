...
export const TypingCat: React.FC<TypingCatProps> = ({ x = 0, y = 0 }) => {
  return (
    <g transform={`translate(${x}, ${y})`} className={styles.typingCat}>
      {/* Ground shadow */}
      <ellipse cx="32" cy="96" rx="28" ry="5" fill="#3a2a1a" opacity="0.18" />
      ...
      <path d="M 5 52 Q 3 58, 4 68 Q 5 74, 7 78 Q 8 68, 8 56 Q 9 50, 5 52" fill="#5a3a1a" opacity="0.06" />
      {/* Vest */}
      ...
      <path d="M 3 30 Q 1 36, 3 42 Q 6 38, 6 32 Q 4 28, 3 30" fill="#5a3a1a" opacity="0.06" />
      {/* Hair */}
