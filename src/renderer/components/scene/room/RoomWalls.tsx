...
export const RoomWalls: React.FC = () => (
  <g>
    ...
    {/* Window light shaft on floor */}
    <rect x="78" y="27" width="32" height="25" fill="url(#windowLight)" opacity="0.3" />
    ...
    {/* Window light shaft */}
    <rect x="290" y="27" width="32" height="25" fill="url(#windowLight)" opacity="0.3" />
