...
export const SleepingCat: React.FC<SleepingCatProps> = ({ x = 0, y = 0 }) => {
  return (
    <g transform={`translate(${x}, ${y})`} className={styles.sleepingCat}>
      {/* Ground shadow */}
      <ellipse cx="30" cy="82" rx="26" ry="5" fill="#3a2a1a" opacity="0.15" />
      ...
      {/* Body shading */}
      <ellipse cx="24" cy="60" rx="8" ry="6" fill="#c4a888" opacity="0.05" />

      {/* Legs tucked (feet poking from blanket) */}
      ...
      <path d="M 8 42 Q 6 48, 8 54 Q 10 50, 10 44 Q 9 40, 8 42" fill="#c4a888" opacity="0.06" />
      {/* Hair tuft */}
