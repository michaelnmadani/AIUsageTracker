...
export const ReadingCat: React.FC<ReadingCatProps> = ({ x = 0, y = 0 }) => {
  return (
    <g transform={`translate(${x}, ${y})`} className={styles.readingCat}>
      {/* Ground shadow */}
      <ellipse cx="28" cy="96" rx="20" ry="4" fill="#3a2a1a" opacity="0.18" />
      ...
      {/* Body shading */}
      <path d="M 10 52 Q 8 58, 9 68 Q 10 74, 12 78 Q 14 68, 14 56 Q 14 50, 10 52" fill="#7a6a5a" opacity="0.07" />
      {/* Cardigan */}
      ...
      <path d="M 8 30 Q 6 36, 8 42 Q 10 38, 10 32 Q 9 28, 8 30" fill="#7a6a5a" opacity="0.06" />

      {/* Hair - darker tips with styled bangs */}
